...
#-Defining data-
data_estat <- list("n"=n,"y"=c(datos$WTI[1:(n-3)],rep(NA,m)), "x"=select(datos, -WTI))
...
set.seed(semilla)
mod_estat.sim<-jags(data_estat,inits,parameters,model.file="Modelos/mod_estatico.txt",
...
# -Pseudo R2-
pseudoR2_estat<-pseudoR2(out_estat.yp)
